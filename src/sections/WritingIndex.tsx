...
const articles: Article[] = [
  {
    ...
    abstract:
      "A training method for MLP transcoders that converges in ~40 minutes (18.5x cheaper than end-to-end), reproduces across seeds (KL std 0.002 vs E2E's 0.134), produces features 2-3x more independent under three cascade tests, and supports anchoring - dropping KL from 0.720 to 0.283 by leaving some layers as real MLPs.",
    href: "/transcoders",
